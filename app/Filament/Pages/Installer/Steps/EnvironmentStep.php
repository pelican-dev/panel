        ...
        return Step::make('environment')
            ...
            ->schema([
                TextInput::make('env.APP_NAME')
                    ->label('App Name')
                    ->hint('This will be the Name of your Panel.')
                    ->required()
                    ->default(config('app.name')),
                TextInput::make('env.APP_URL')
                    ->label('App URL')
                    ->hint('This will be the URL you access your Panel from.')
                    ->required()
                ...
                ToggleButtons::make('env.CACHE_STORE')
                    ->label('Cache Driver')
                    ->hint('The driver used for caching. We recommend "Filesystem".')
                    ->required()
                    ->grouped()
                ...
                ToggleButtons::make('env.SESSION_DRIVER')
                    ...
                    ->hint('The driver used for storing sessions. We recommend "Filesystem" or "Database".')
                    ->required()
                    ->grouped()
                ...
                ToggleButtons::make('env.QUEUE_CONNECTION')
                    ->label('Queue Driver')
                    ->hint('The driver used for handling queues. We recommend "Database".')
                    ->required()
                    ->grouped()
                ...
                ToggleButtons::make('env.DB_CONNECTION')
                    ...
                    ->hint('The driver used for the panel database. We recommend "SQLite".')
                    ->required()
                    ->grouped()
