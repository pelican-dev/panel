                        ...
                        ->schema([
                            ...
                            Forms\Components\Actions::make([
                                Forms\Components\Actions\Action::make('resetKey')
                                    ...
                                    ->action(fn (NodeUpdateService $nodeUpdateService, Node $node) => $nodeUpdateService->handle($node, [], true) && Notification::make()->success()->title('Daemon Key Reset')->send() && $this->fillForm()),
                            ]),
                        ]),
                ]),
        ]);
