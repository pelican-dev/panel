...
/**
 * @property DaemonSystemRepository $daemonSystemRepository
 * @property NodeUpdateService $nodeUpdateService
 */
trait NodeDetailTabs
{
    /** @return Tab[] */
    protected function detailTabs(): array
    {
        return [
            Tab::make('overview')
