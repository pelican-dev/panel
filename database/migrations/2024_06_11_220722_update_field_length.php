...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('databases', function (Blueprint $table) {
            ...
            $table->string('username', 255)->change();
            $table->string('remote', 255)->default('%')->change();
        });
        ...
        Schema::table('eggs', function (Blueprint $table) {
            ...
            $table->string('script_container', 255)->default('alpine:3.4')->change();
            $table->string('script_entry', 255)->default('ash')->change();
        });
        ...
        Schema::table('nodes', function (Blueprint $table) {
            ...
            $table->string('scheme', 255)->default('https')->change();
