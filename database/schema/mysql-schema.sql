...
CREATE TABLE `nodes` (
  ...
  `daemon_listen` smallint(5) unsigned NOT NULL DEFAULT 8080,
  `daemon_sftp` smallint(5) unsigned NOT NULL DEFAULT 2022,
  `daemon_base` varchar(191) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (198,'2024_04_14_002250_update_column_names',4);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (199,'2024_04_20_214441_add_egg_var_sort',5);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (205,'2024_05_08_184942_create_permission_tables',10);
