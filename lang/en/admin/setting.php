...
return [
    ...
    'misc' => [
        'auto_allocation' => [
            ...
            'create_new_help' => 'When enabled, creates new allocations from the range below if no unassigned allocations exist. When disabled, only assigns from existing unassigned allocations.',
            'start' => 'Start Port',
            'end' => 'End Port',
        ],
        'mail_notifications' => [
