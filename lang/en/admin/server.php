...
return [
    ...
    'notifications' => [
        ...
        'clone_loaded' => 'Cloning :server',
        'clone_loaded_body' => 'The configuration of the server was copied over, you only need to pick a new allocation. Files, databases, backups, schedules and subusers are not cloned.',
