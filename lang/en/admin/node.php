...
return [
    ...
    'daemon_app_name' => 'Console Name',
    'daemon_app_name_help' => 'Name shown in the server console, in the daemon prefix and the prompt. Leave empty to use the panel name.',
