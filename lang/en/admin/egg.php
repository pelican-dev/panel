...
return [
    'tabs' => [
        ...
        'egg_variables' => ':resource Variables',
    ...
    'name' => 'Name',
    'name_help' => 'A simple, human-readable name to use as an identifier for this :resource.',
    'author' => 'Author',
    'uuid_help' => 'This is the globally unique identifier for this :resource which :wings uses as an identifier.',
    'author_help' => 'The author of this version of the :resource.',
    'author_help_edit' => 'The author of this version of the :resource. Uploading a new configuration from a different author will change this.',
    'description' => 'Description',
    'description_help' => 'A description of this :resource that will be displayed throughout the Panel as needed.',
    'startup' => 'Startup Command',
    'startup_help' => 'The default startup command that should be used for new servers using this :resource.',
    ...
    'force_ip_help' => 'Forces all outgoing network traffic to have its Source IP NATed to the IP of the server\'s primary allocation IP. Required for certain games to work properly when the Node has multiple public IP addresses. Enabling this option will disable internal networking for any servers using this :resource, causing them to be unable to internally access other servers on the same node.',
    'tags' => 'Tags',
    ...
    'docker_help' => 'The docker images available to servers using this :resource.',
