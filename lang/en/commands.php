...
return [
    ...
    'environment_check' => [
        ...
        'warning' => 'WARN',
        'failed' => 'FAIL',
        'preflight_passed' => 'Environment preflight passed.',
        'preflight_failed' => 'Environment preflight failed. Resolve every failed check before continuing.',
        'health_passed' => 'Panel health validation passed.',
        'health_failed' => 'Panel health validation failed. Resolve every failed check before continuing.',
    ],
    'update' => [
        'preparation_failed' => 'The update was not prepared because one or more safety checks failed.',
        ...
        'snapshot_missing' => 'No pre-update snapshot was found. Create one before changing the application.',
        'compatibility_failed' => 'The target release is not compatible with this server:',
        'compatibility_passed' => 'Composer platform requirements are compatible with this server.',
        'compatibility_label' => 'Target release compatibility',
        ...
        'compatibility_command_failed' => "Composer's platform validation failed:\n:details",
        'compatibility_remediation' => 'Install the PHP version and extensions required by the target release before changing application files.',
        ...
        'database_backup_sqlite' => 'The SQLite database was copied to :path.',
        'database_backup_mysql' => 'Create a consistent backup before updating, for example: mysqldump --single-transaction --quick --lock-tables=false DATABASE_NAME > panel-before-update.sql',
        'database_backup_pgsql' => 'Create a consistent backup before updating, for example: pg_dump --format=custom --file=panel-before-update.dump DATABASE_NAME',
        'database_backup_unknown' => 'Create and verify a database backup using the tools recommended for the configured database driver.',
        'database_guidance' => 'Database backup guidance: :guidance',
        'ready' => 'Pre-update checks passed. Keep the snapshot until the post-update health check succeeds.',
        'healthy' => 'The post-update health check passed. The snapshot can be archived or removed after final verification.',
        'unhealthy' => 'The update is not healthy. Stop here and follow the rollback guide at: :path',
    ],
    'make_node' => [
