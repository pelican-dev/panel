...
return [
    ...
    */
    ...
    "install" => [
        "first_commit" => "Do not run this command if you have already ran this command before on this panel. If you do this could result in data loss.",
        "first_question" => "Are you sure you have not run this command before?",
        "yes_first" => "Yes, I have not run this command before on this panel",
        ...
        "webserver_setup_question" => "Do you want to setup the webserver configuration?",
        "webserver_setup_answer1" => "Yes, I want this command to setup the webserver configuration.",
        "webserver_setup_answer2" => "No, I want to manually add my webserver configuration.",
        "what_webserver_question" => "What webserver have you got?",
        "what_webserver_answer1" => "Nginx",
        "what_webserver_answer2" => "Apache",
        "what_webserver_answer3" => "Caddy",
        "ssl_question" => "Do you want to generate an SSL for your panel?",
        "yes_ssl" => "Yes, I want to generate an SSL",
        "no_ssl" => "No, I don't want an SSL.",
    ]
];
