...
return [
    ...
    'environment' => [
        'mail' => [
            ...
            'ask_mandrill_secret' => 'הסוד של Mandrill',
            'ask_postmark_username' => 'מפתח API של Postmark',
            'ask_driver' => 'באיזה התקן יש להשתמש לשליחת הודעות דוא"ל',
            'ask_mail_from' => 'כתובת דוא"ל צריכה להגיע מ-',
            'ask_mail_name' => 'שם שממנו הודעות דוא"ל אמורות להופיע',
            'ask_encryption' => 'שיטת הצפנה לשימוש',
        ],
    ],
];
