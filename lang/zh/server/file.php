...
return [
    ...
    'actions' => [
        ...
        'move' => [
            'title' => '移動',
            'directory' => '目錄',
            'directory_hint' => '輸入新資料夾名稱，相對於目前目錄。',
            'new_location' => '新的位置',
            'new_location_hint' => '輸入此檔案或資料夾的位置，相對於目前目錄。',
            'notification' => '檔案已移動',
            'bulk_notification' => ':count 個檔案已移動至 :directory',
        ],
        'permissions' => [
            'title' => '權限',
            'read' => '讀',
        ...
        'nested_search' => [
            'title' => '包含子目錄搜尋',
            'search_term' => '關鍵字',
            'search_term_placeholder' => '輸入關鍵字，例如：*.txt',
            'search' => 'Search',
    ...
    'alerts' => [
        ...
        'pelicanignore' => [
            ...
            'body' => '此處列出的任何檔案或目錄都將從備份中排除。支援使用星號 (<code>*</code>) 作為萬用字元。<br>您可以透過在前面加上驚嘆號 (<code>!</code>) 來否定先前的規則。',
        ],
    ],
];
