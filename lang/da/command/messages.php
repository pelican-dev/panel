...
return [
    'user' => [
        'search_users' => 'Indtast et brugernavn, bruger ID eller email adresse',
    ...
    'environment' => [
        'mail' => [
            ...
            'ask_driver' => 'Hvilken driver skal bruges til at sende emails?',
            'ask_mail_from' => 'Email adresse emails skal stamme fra',
            'ask_mail_name' => 'Navn som emails skal vises fra',
