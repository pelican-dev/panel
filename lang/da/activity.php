...
return [
    'auth' => [
        ...
        'checkpoint' => '2-faktor godkendelse anmodet',
        'recovery-token' => '2-faktor gendannelses-token brugt',
        'token' => 'Løst 2-faktor udfordring',
    ...
    'user' => [
        ...
        'ssh-key' => [
            'create' => 'SSH-key :fingerprint tilføjet til konto',
            'delete' => 'SSH-key :fingerprint fjernet fra konto',
        ],
        'two-factor' => [
            'create' => '2-faktor godkendelse aktiveret',
            'delete' => '2-faktor godkendelse deaktiveret',
        ],
    ],
    'server' => [
        'reinstall' => 'Serveren blev geninstalleret',
        'console' => [
            'command' => 'Udført ":command" på serveren',
        ],
        'power' => [
            'start' => 'Serveren blev startet',
            'stop' => 'Serveren blev stoppet',
            'restart' => 'Serveren blev genstartet',
        ...
        'backup' => [
            ...
            'unlock' => 'Oplåste :name backup',
        ],
        'database' => [
            'create' => 'Oprettede ny database :name',
            'rotate-password' => 'Adgangskode roteret for database :name',
            'delete' => 'Slettede database :name',
        ],
        'file' => [
            'compress_one' => 'Komprimeret :directory:file',
            'compress_other' => 'Komprimeret :count filer i :directory',
            'read' => 'Viste indholdet af :file',
            'copy' => 'Kopi af :file blev oprettet',
            'create-directory' => 'Mappen :directory:name blev oprettet',
