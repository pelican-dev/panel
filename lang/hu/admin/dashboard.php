...
return [
    ...
    'sections' => [
        ...
        'intro-update-available' => [
            ...
            'content' => ':latestVersion már elérhető! Olvassa el dokumentációnkat a panel frissítéséhez.',
        ],
        'intro-no-update' => [
            'heading' => 'A Panel naprakész',
            'content' => 'Ön a Pelican :version verzióját futtatja. Az Ön panelje naprakész!',
        ],
        'intro-first-node' => [
        ...
        'intro-help' => [
            ...
            'content' => 'Először nézze meg a dokumentációt! Ha még mindig segítségre van szükséged, látogass el a Discord szerverünkre!',
