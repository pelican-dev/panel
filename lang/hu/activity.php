...
return [
    ...
    'server' => [
        ...
        'schedule' => [
            'create' => 'Létrehozva: <b>:name</b> ütemezés',
            'update' => 'Frissítve: <b>:name</b> ütemezés',
            'execute' => 'Manuálisan végrehajtva: <b>:name</b> ütemezés',
            'delete' => 'Törölve: <b>:name</b> ütemezés',
        ],
        'task' => [
            'create' => 'Új feladat létrehozva: "<b>:action</b>" a(z) <b>:name</b> ütemezéshez',
            'update' => 'Frissítve: "<b>:action</b>" feladat a(z) <b>:name</b> ütemezésben',
            'delete' => 'Törölve: "<b>:action</b>" feladat a(z) <b>:name</b> ütemezésből',
        ],
        'settings' => [
