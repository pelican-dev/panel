...
return [
    ...
    'upgrade' => [
        'integrity' => 'Cette commande ne vérifie pas l\'intégrité des fichiers téléchargés. Veuillez vous assurer que vous faites confiance à la source de téléchargement avant de continuer. Si vous ne souhaitez pas télécharger une archive, veuillez l\'indiquer en utilisant l\'option --skip-download ou en répondant « non » à la question ci-dessous.',
        'source_url' => 'Source de téléchargement (définie avec --url=) :',
        'php_version' => 'Impossible d\'exécuter le processus d\'automise à jour. La version minimale requise de PHP est 7.4.0, vous avez',
        'skipDownload' => 'Voulez-vous télécharger et décompresser les fichiers d\'archive de la dernière version ?',
        'webserver_user' => 'L\'utilisateur de votre serveur web a été détecté comme <fg=blue>[{:user}]:</> est-ce correct ?',
        'name_webserver' => 'Veuillez saisir le nom de l\'utilisateur qui exécute le processus de votre serveur web. Ce nom varie d\'un système à l\'autre, mais il s\'agit généralement de « www-data », « nginx » ou « apache ».',
        'group_webserver' => 'Votre groupe de serveur web a été détecté comme <fg=blue>[{:group}]:</> est-ce correct ?',
        'group_webserver_question' => 'Veuillez saisir le nom du groupe qui exécute le processus de votre serveur web. Normalement, il s\'agit du même nom que celui de votre utilisateur.',
        'are_your_sure' => 'Êtes-vous sûr de vouloir exécuter la procédure de mise à niveau pour votre Panel ?',
        'terminated' => 'Le processus de mise à niveau a été interrompu par l\'utilisateur.',
        'success' => 'Le Panel a été mis à jour avec succès. Veuillez vous assurer que vous mettez également à jour toutes les instances de daemon',
