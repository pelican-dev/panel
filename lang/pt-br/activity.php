...
/**
 * Contém todas as strings de tradução para diferentes eventos de log de atividades.
 * Estas devem ser indexadas pelo valor em frente ao dois pontos (:) no nome do evento.
 * Se não houver dois pontos presentes, elas devem estar no nível superior.
 */
return [
    'auth' => [
