...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para trocar os placeholders de atributo
    | por algo mais amigável ao leitor, como "Endereço de E-Mail" em vez de "email".
    | Isso simplesmente nos ajuda a tornar as mensagens um pouco mais limpas.
    |
    */

    'attributes' => [],

    // Lógica de validação interna para o Painel
    'internal' => [
