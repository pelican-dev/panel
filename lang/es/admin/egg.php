...
return [
    ...
    'import' => [
        ...
        'egg_help' => 'Este debería ser un archivo .json/.yaml',
    ...
    'force_ip_help' => 'Fuerza que todo el tráfico saliente use como IP de origen la IP de la allocation primaria del servidor (NAT). Es necesario para algunos juegos cuando el node tiene múltiples IP públicas.
Activar esta opción deshabilita la red interna de los servidores que usen este egg, por lo que no podrán comunicarse internamente con otros servidores del mismo node.',
    'tags' => 'Etiquetas',
    ...
    'copy_from_help' => 'Si desea que la configuración predeterminada de otro egg, selecciónelo en el menú de arriba.',
    'none' => 'Ninguno',
