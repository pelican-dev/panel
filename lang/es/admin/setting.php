...
return [
    ...
    'misc' => [
        'auto_allocation' => [
            'title' => 'Creación automática de allocations',
            'helper' => 'Alternar si los usuarios pueden crear allocations a través del área del cliente.',
            'question' => '¿Permitir a los usuarios crear allocations?',
            'create_new' => '¿Crear nuevas allocations si no hay ninguna disponible?',
            'create_new_help' => 'Cuando está activado, crea nuevas allocations; cuando está desactivado, solo asigna a partir de allocations existentes sin usar, y ambas opciones tienen en cuenta el rango de puertos indicado a continuación.',
