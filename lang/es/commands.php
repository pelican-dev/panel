...
return [
    ...
    'make_node' => [
        'name' => 'Introduce un identificador corto utilizado para distinguir este node de otros',
        'description' => 'Introduce una descripción para identificar el node',
        ...
        'public' => '¿Debería este node ser público? Como nota, al establecer un nodo como privado, estarás denegando la capacidad de desplegar automáticamente en este node.',
        ...
        'daemonSFTPAlias' => 'Introduzca el nombre del daemon SFTP (puede estar vacío)',
        'daemonBase' => 'Introduzca la carpeta raíz',
        'success' => 'Se ha creado correctamente un nuevo node con el nombre :name y tiene un id de :id',
    ],
    'node_config' => [
        'error_not_exist' => 'El node seleccionado no existe.',
    ...
    'schedule' => [
        'process' => [
            ...
            'error_message' => 'Se produjo un error al procesar la schedule: :schedules',
        ],
    ],
];
