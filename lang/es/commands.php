...
return [
    ...
    'upgrade' => [
        ...
        'webserver_user' => 'Se ha detectado que el usuario del servidor web es <fg=blue>[{:user}]:</>, ¿es esto correcto?',
        'name_webserver' => 'Por favor, introduce el nombre del usuario que ejecuta el proceso del servidor web. Esto varía de un sistema a otro, pero generalmente es "www-data", "nginx" o "apache".',
        'group_webserver' => 'Se ha detectado que el grupo del servidor web es <fg=blue>[{:group}]:</>, ¿es esto correcto?',
        'group_webserver_question' => 'Por favor, introduce el nombre del grupo que ejecuta el proceso del servidor web. Normalmente es el mismo que tu usuario.',
        'are_your_sure' => '¿Estás seguro de que deseas ejecutar el proceso de actualización para su Panel?',
        'terminated' => 'El proceso de actualización ha sido terminado por el usuario.',
        'success' => 'El Panel ha sido actualizado correctamente. Asegúrate también de actualizar todas los demonios',
