...
return [
    ...
    'database' => [
        ...
        'fields' => [
            ...
            'host_help' => 'El host de tu base de datos. Asegúrese de que es accesible.',
    ...
    'egg' => [
        ...
        'exceptions' => [
            ...
            'installation_failed' => 'Error al instalar los eggs seleccionados. Por favor importarlos después de la instalación a través de la lista de eggs.',
        ],
    ],
    'session' => [
        'title' => 'Sesión',
