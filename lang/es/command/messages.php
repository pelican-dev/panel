...
return [
    ...
    'server' => [
        'rebuild_failed' => 'La solicitud de reconstrucción para ":name" (#:id) en el node ":node" falló con el error: :message',
        'reinstall' => [
            'failed' => 'La solicitud de reinstalación para ":name" (#:id) en el node ":node" falló con el error: :message',
        ...
        'power' => [
            ...
            'action_failed' => 'La acción para ":name" (#:id) en el node ":node" falló con el error: :message',
        ],
    ],
    'environment' => [
        'mail' => [
