...
return [
    ...
    'node' => [
        'servers_attached' => 'Un node no debe tener servidores vinculados a él para poder ser eliminado.',
    ...
    'allocations' => [
        'server_using' => 'Actualmente hay un servidor utilizando esta allocation. Una allocation solo puede ser eliminada si ningún servidor está utilizándola actualmente.',
    ...
    'egg' => [
        ...
        'has_children' => 'Este egg es parte de uno o más eggs. Por favor, elimina esos eggs antes de eliminar este egg.',
    ],
    'variables' => [
    ...
    'locations' => [
        'has_nodes' => 'No se puede eliminar una ubicación que tiene nodes activos vinculados a ella.',
    ],
    'users' => [
    ...
    'deployment' => [
        'no_viable_nodes' => 'No se encontraron nodes que satisfagan los requisitos especificados para el despliegue automático.',
        'no_viable_allocations' => 'No se encontraron allocations que satisfagan los requisitos para el despliegue automático.',
    ],
    'api' => [
