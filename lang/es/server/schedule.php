...
return [
    'title' => 'Schedules',
    'new' => 'Nuevo schedule',
    'edit' => 'Editar schedule',
    'save' => 'Guardar schedule',
    'delete' => 'Eliminar schedule',
    'import' => 'Importar schedule',
    'export' => 'Exportar schedule',
    'name' => 'Nombre',
    'cron' => 'Cron',
    'status' => 'Estado',
    'schedule_status' => [
    ...
    'only_online_hint' => 'Solo ejecutar este schedule cuando el servidor esté en ejecución.',
    'enabled' => '¿Activar schedule?',
    'enabled_hint' => 'Este schedule se ejecutará automáticamente si está activada.',
