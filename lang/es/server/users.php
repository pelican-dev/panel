...
return [
    'permissions' => [
        ...
        'setting_reinstall' => 'Permite al usuario activar una reinstalación de este servidor.',
        'setting_rename' => 'Permite al usuario renombrar este servidor y cambiar su descripción.',
        'activity_read' => 'Permite al usuario ver los registros de actividad del servidor.',
        'websocket_*' => 'Permite al usuario acceder al websocket de este servidor.',
