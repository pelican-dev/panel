...
https://php.net/manual/zh/timezones.php。',
    ...
    'upgrade' => [
        'integrity' => '此命令不会检查已下载资源的安全性。在继续之前，请确保您信任下载源。如果您不想下载此压缩文件，请使用 --skip-download 参数，或者对以下问题回答“否”',
        'source_url' => '下载源(使用参数 --url= 设置):',
        'php_version' => '无法进行自动升级。需要的最低 PHP 版本为 7.4.0，您运行的版本是',
        'skipDownload' => '您是否要下载并解压最新版本的压缩文件？',
        'webserver_user' => '检测到您的 Web 服务器使用的用户为 <fg=blue>[{:user}]:</> 
它是否正确？',
        'name_webserver' => '请输入运行 Web 服务器进程使用的用户名称。此名称因系统而异，通常是“www-data”、“nginx”或“apache”。',
        'group_webserver' => '检测到您的 Web 服务器使用的用户组为 <fg=blue>[{:group}]:</> 
它是否正确？',
        'group_webserver_question' => '请输入运行 Web 服务器进程使用的用户组名称。通常，该名称与您的用户相同。',
        'are_your_sure' => '您确实要运行面板的更新程序吗？',
        'terminated' => '更新程序已被用户终止。',
        'success' => '面板已成功更新，请确保你也更新了后端程序。',
