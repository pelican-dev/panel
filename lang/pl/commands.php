...
return [
    'appsettings' => [
        'comment' => [
            ...
            'url' => 'Adres URL aplikacji MUSI zaczynać się od https:// lub http:// w zależności od tego, czy używasz SSL czy nie. Jeśli nie zastosujesz ego schematu, adresy e-mail i inne treści będą linkować do złej lokalizacji.',
