...
return [
    'user' => [
        ...
        '2fa_help_text' => [
            'Ta komenda wyłączy uwierzytelnianie dwuetapowe dla konta użytkownika, jeśli jest włączone. Powinna być używana wyłącznie jako komenda do odzyskiwania konta, jeśli użytkownik jest zablokowany na swoim koncie.',
            'Jeśli nie chcesz tego zrobić, naciśnij CTRL+C, aby zakończyć ten proces.',
        ],
