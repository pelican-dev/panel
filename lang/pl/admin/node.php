...
return [
    ...
    'refresh' => 'Odśwież',
    'custom_ip' => 'Wprowadź niestandardowy adres IP',
    'domain' => 'Nazwa domeny',
    'ssl_ip' => 'Warto rozważyć użycie nazwy domeny zamiast adresu IP',
    'fqdn_ssl' => 'Twój panel jest obecnie zabezpieczony certyfikatem SSL, co oznacza, że Twoje węzły również go wymagają.',
    'dns_error' => 'Nie znaleziono żadnych prawidłowych wpisów DNS dla podanej nazwy domeny.',
    'valid' => 'Prawidłowy DNS',
    'invalid' => 'Niepoprawny DNS',
    'port' => 'Port',
    'ports' => 'Porty',
    ...
    'panel_on_ssl' => 'Twój panel korzysta z bezpiecznego połączenia SSL, więc Twój demon również musi z niego korzystać.',
    'ssl_help' => 'Adres IP nie może korzystać z SSL.',

    'tags' => 'Tagi',
    'upload_limit' => 'Limit przesyłania',
    'upload_limit_help' => 'Wprowadź maksymalny rozmiar plików, które można przesłać za pomocą internetowego menedżera plików.',
    'sftp_port' => 'Port SFTP',
    'sftp_alias' => 'Alias SFTP',
    'sftp_alias_help' => 'Wyświetl alias dla adresu SFTP. Pozostaw puste, aby użyć węzła FQDN.',
    'daemon_base' => 'Katalog podstawowy demona',
    'daemon_base_help' => 'Katalog, w którym będą przechowywane dane serwera.',
