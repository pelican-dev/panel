...
return [
    'user' => [
        ...
        'deleted' => 'Ο χρήστης διαγράφηκε επιτυχώς από το panel.',
        'confirm_delete' => 'Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτόν το χρήστη απο το panel;',
        'no_users_found' => 'Δεν βρέθηκαν χρήστες για τον όρο αναζήτησης που παρείχατε.',
        'multiple_found' => 'Βρέθηκαν πολλαπλοί λογαριασμοί για αυτόν τον χρήστη, αδυναμία διαγραφής του χρήστη λόγω της σημαίας --no-interaction flag.',
    ...
    'server' => [
        ...
        'reinstall' => [
            ...
            'confirm' => 'Πρόκειται να επανεγκαταστήσετε ενάντια σε έναν αριθμό διακομιστών. Θέλετε να συνεχίσετε;',
        ],
        'power' => [
            'confirm' => 'Πρόκειται να εκτελέσετε ένα :action σε :count διακομιστές. Θέλετε να συνεχίσετε;',
