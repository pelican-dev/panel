...
return [
    'user' => [
        ...
        'select_search_user' => 'Αναγνωριστικό χρήστη για διαγραφή (Πατήστε \'0\' για νέα αναζήτηση)',
        ...
        'no_users_found' => 'Δε βρέθηκαν χρήστες για τον όρο αναζήτησης που παρείχατε.',
        ...
        'ask_password' => 'Κωδικός πρόσβασης',
