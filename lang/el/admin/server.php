...
return [
    ...
    'alerts' => [
        'startup_changed' => 'Η ρύθμιση παραμέτρων εκκίνησης για αυτόν τον διακομιστή έχει ενημερωθεί. Αν το egg αυτού του διακομιστή έχει αλλάξει θα πραγματοποιηθεί επανεγκατάσταση τώρα.',
        ...
        'rebuild_on_boot' => 'Αυτός ο διακομιστής έχει επισημανθεί ως απαιτεί rebuild του Docker. Αυτό θα συμβεί την επόμενη φορά που θα ξεκινήσει ο διακομιστής.',
