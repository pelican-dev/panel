...
return [
    'exceptions' => [
        'no_new_default_allocation' => 'Προσπαθείτε να διαγράψετε ένα προεπιλεγμένο allocation για αυτόν το διακομιστή, αλλά δεν υπάρχει εφεδρικό allocation για χρήση.',
        ...
        'daemon_exception' => 'Υπήρξε ένα exception κατά την προσπάθεια επικοινωνίας με το daemon ως αποτέλεσμα να υπάρχει κωδικός απόκρισης HTTP/:code. Αυτό το exception έχει καταγραφεί. (αναγνωριστικό αιτήματος: :request_id)',
        'default_allocation_not_found' => 'To προεπιλεγμένo allocation που ζητήθηκε δεν βρέθηκε στα allocations αυτού του διακομιστή.',
    ],
    'alerts' => [
        'startup_changed' => 'Το startup configuration για αυτόν το διακομιστή έχει ενημερωθεί. Αν το egg αυτού του διακομιστή έχει αλλάξει θα πραγματοποιηθεί επανεγκατάσταση τώρα.',
        'server_deleted' => 'Ο διακομιστής έχει διαγραφεί με επιτυχία από το σύστημα.',
        'server_created' => 'Ο διακομιστής δημιουργήθηκε με επιτυχία στο panel. Παρακαλώ επιτρέψτε στο daemon λίγα λεπτά να εγκαταστήσει πλήρως αυτόν το διακομιστή.',
        ...
        'rebuild_on_boot' => 'Αυτός ο διακομιστής έχει επισημανθεί πως απαιτεί rebuild του Docker Container. Αυτό θα συμβεί την επόμενη φορά που θα ξεκινήσει ο διακομιστής.',
        ...
        'docker_image_updated' => 'Η προεπιλεγμένο Docker image άλλαξε επιτυχώς για να χρησιμοποιηθεί για αυτόν το διακομιστή. Απαιτείται επανεκκίνηση για να εφαρμοστεί αυτή η αλλαγή.',
