...
return [
    'notices' => [
        'imported' => 'Επιτυχής εισαγωγή αυτού του egg και των σχετικών μεταβλητών.',
        'updated_via_import' => 'Αυτό το egg έχει ενημερωθεί χρησιμοποιώντας το αρχείο που παρείχατε.',
        ...
        'script_updated' => 'Το σενάριο εγκατάστασης των egg έχει ενημερωθεί και θα εκτελείται όποτε εγκαθίστανται οι διακομιστές.',
