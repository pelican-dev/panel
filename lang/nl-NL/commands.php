...
return [
    ...
    'upgrade' => [
        'integrity' => 'Dit commando controleert niet de integriteit van gedownloade assets. Zorg ervoor dat je de downloadbron vertrouwt voordat je doorgaat. Als je geen archief wilt downloaden, geef dat aan met behulp van de --skip-download vlag, of door "nee" op de vraag hieronder te beantwoorden.',
        'source_url' => 'Download bron (ingesteld met --url=):',
        'php_version' => 'Kan zelf-upgrade proces niet uitvoeren. Het minimum vereiste PHP versie vereist is 7.4.0, u heeft',
        'skipDownload' => 'Wilt u de archiefbestanden voor de laatste versie downloaden en uitpakken?',
        'webserver_user' => 'Je webserver groep is gedetecteerd als <fg=blue>[{:user}]:</> is dit juist?',
        'name_webserver' => 'Vul de naam in van de gebruiker die uw webserverproces draait. Dit varieert van systeem tot systeem, maar is over het algemeen "www-data", "nginx" of "apache".',
        'group_webserver' => 'Je webserver groep is gedetecteerd als <fg=blue>[{:group}]:</> is dit juist?',
        'group_webserver_question' => 'Voer de naam in van de groep die uw webserverproces draait. Normaal gesproken is dit dezelfde als uw gebruiker.',
        'are_your_sure' => 'Weet u zeker dat u het upgrade proces voor uw Paneel wilt uitvoeren?',
        'terminated' => 'Upgrade proces beëindigd door gebruiker.',
        'success' => 'Het paneel is succesvol geüpgraded. Zorg ervoor dat je alle Daemon instanties bijwerkt',
