...
return [
    'permissions' => [
        ...
        'startup_docker_image' => 'Дозволяє користувачеві змінювати Docker-образ, що використовується для запуску сервера.',
        'setting_reinstall' => 'Дозволяє користувачеві перезапустити процес встановлення сервера.',
        'setting_rename' => 'Дозволяє користувачеві перейменовувати сервер і змінювати його опис.',
