...
return [
    'user' => [
        'search_users' => 'Введіть ім\'я користувача, ID користувача або адресу електронної пошти',
        'select_search_user' => 'ID користувача для видалення (введіть \'0\' для повторного пошуку)',
        ...
        'ask_admin' => 'Чи має цей користувач права адміністратора?',
        'ask_email' => 'Адреса електронної пошти',
        'ask_username' => 'Ім\'я користувача',
        'ask_password' => 'Пароль',
        'ask_password_tip' => 'Якщо ви хочете створити обліковий запис із випадковим паролем, який буде надіслано користувачеві електронною поштою, перезапустіть цю команду (CTRL+C) із параметром `--no-password`.',
        'ask_password_help' => 'Пароль має містити щонайменше 8 символів, хоча б одну велику літеру та одну цифру.',
        '2fa_help_text' => [
            'Ця команда відключить 2-факторну аутентифікацію для облікового запису користувача, якщо вона увімкнена. Це слід використовувати тільки якщо потрібно відновити обліковий запис.',
            'Якщо це не те, що ви хотіли зробити, натисніть CTRL+C, щоб вийти.',
        ],
        '2fa_disabled' => 'Двофакторна автентифікація для :email вимкнена.',
    ],
    'schedule' => [
