...
return [
    ...
    'ip_help' => 'Зазвичай це публічна IP-адреса вашої машини, якщо ви не використовуєте проброс портів.',
    'alias_help' => 'Необов’язковий відображуваний псевдонім для ідентифікації вузла.',
    'domain' => 'Доменне ім\'я',
    'ssl_ip' => 'Не можна підключитися до IP-адреси через SSL',
    ...
    'limited' => 'Обмежено',
    'overallocate' => 'Перевиділення ресурсів',
    'enabled' => 'Увімкнено',
    'disabled' => 'Вимкнено',
    'yes' => 'Так',
    'no' => 'Ні',
    ...
    'auto_question' => 'Оберіть між самостійним розгортанням або установкою через Docker.',
