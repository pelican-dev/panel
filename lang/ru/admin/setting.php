...
return [
    ...
    'misc' => [
        ...
        'mail_notifications' => [
            ...
            'added_to_server' => 'Добавлен на сервер',
        ...
        'api' => [
            'title' => 'АПИ',
            'helper' => 'Определяет лимит для количества запросов, которые могут быть выполнены за заданный период.',
            'requests_per_period' => 'Запросов за период',
            'requests' => 'Запросы',
            'minutes' => 'Минуты',
            'period_length' => 'Длина периода',
            'client_title' => 'Лимит API клиента',
            'client_helper' => 'Ограничение на одного пользователя, или IP если нет пользователя',
            'application_title' => 'Лимит запросов API приложения',
            'application_helper' => 'Ограничение на одного пользователя, или IP если нет пользователя',
            'password_reset_title' => 'Период сброса пароля',
            'password_reset_helper' => 'Ограничение по IP',
            'websocket_title' => 'Лимит WebSocket',
            'websocket_helper' => 'Ограничение на сервер',
            'backup_restore_title' => 'Резервное копирование и восстановление RateLimit',
            'backup_restore_helper' => 'Ограничение на сервер',
            'database_create_title' => 'Ограничение на создание Баз Данных',
            'database_create_helper' => 'Ограничение на сервер',
            'subuser_create_title' => 'Ограничение на создание пользователей сервера',
            'subuser_create_helper' => 'Ограничение на сервер',
            'file_pull_title' => 'Ограничение на загрузку файлов',
            'file_pull_helper' => 'Ограничение на сервер',
            'default_title' => 'Стандартный лимит',
            'default_helper' => 'Ограничение на сервер',
        ],
        'server' => [
            'title' => 'Сервера',
