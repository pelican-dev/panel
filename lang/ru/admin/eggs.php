...
return [
    ...
    'variables' => [
        'notices' => [
            'variable_deleted' => 'Переменная ":variable" удалена. После перезагрузки серверов она более не будет им доступна.',
            'variable_updated' => 'Переменная ":variable" обновлена. Для применения изменений на серверах необходимо их перезагрузить.',
