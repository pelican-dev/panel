...
return [
    ...
    'egg' => [
        'title' => 'Eggs',
        'no_eggs' => 'Geen eggs beschikbaar',
        'background_install_started' => 'Egg installeren begonnen',
        'background_install_description' => 'De installatie van :count eggs staat in de wachtrij en gaat in de achtergrond door.',
        'exceptions' => [
            'failed_to_update' => 'Egg index bijwerken mislukt',
            'no_eggs' => 'Er zijn momenteel geen eggs beschikbaar om te installeren.',
            'installation_failed' => 'De installatie van de geselecteerde eggs is mislukt. Importeer ze na de installatie via de eggs lijst.',
        ],
    ],
    'session' => [
        'title' => 'Sessie',
