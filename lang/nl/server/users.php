...
return [
    'permissions' => [
        ...
        'setting_reinstall' => 'Staat een gebruiker toe om een herinstallatie van deze server te starten.',
        'setting_rename' => 'Laat een gebruiker de naam van deze server wijzigen en de beschrijving wijzigen.',
