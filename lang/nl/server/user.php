...
return [
    ...
    'permissions' => [
        ...
        'settings_change_icon' => 'Staat een gebruiker toe het icoon van de server te wijzigen.',
        ...
        'mount_desc' => 'Machtigingen die bepalen of een gebruiker de mounts van deze server mag wijzigen.',
        'mount_read' => 'Staat een gebruiker toe de mounts te bekijken.',
        'mount_update' => 'Hiermee kan een gebruiker mounts in- of uitschakelen voor de server.',
    ],
];
