...
return [
    ...
    'display_name_help' => 'Een korte identifier gebruikt om deze locatie te onderscheiden van anderen. Moet tussen de 1 en 60 tekens lang zijn, bijvoorbeeld nl.ams.lvl1.',
    'username' => 'Gebruikersnaam',
    ...
    'setup' => [
        ...
        'allow_external_access' => '
                                    <p>Kansen bestaan dat u externe toegang tot deze MySQL-instantie moet toestaan om servers verbinding te laten maken.</p>
                                    <br>
                                    <p>Om dit te doen open <code>my.cnf</code>, de locatie varieert afhankelijk van uw besturingssysteem en hoe MySQL is geïnstalleerd. Je kunt <code>/etc -iname my.cnf</code> uitvoeren om het te vinden.</p>
                                    <br>
                                    <p>Open <code>my.cnf</code>, voeg hieronder tekst toe aan de onderkant van het bestand en sla deze op:<br>
