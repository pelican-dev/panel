...
return [
    'permissions' => [
        ...
        'user_read' => 'Erlaubt dem Benutzer, die mit diesem Server verbundenen Benutzer anzuzeigen.',
        'user_update' => 'Erlaubt dem Benutzer, andere mit diesem Server verbundene Benutzer zu ändern.',
        'user_delete' => 'Erlaubt dem Benutzer, andere mit diesem Server verbundene Benutzer zu löschen.',
        'file_create' => 'Erlaubt dem Benutzer, neue Dateien und Verzeichnisse zu erstellen.',
        'file_read' => 'Erlaubt dem Benutzer, Dateien und Ordner zu sehen, die dieser Serverinstanz zugeordnet sind, sowie deren Inhalt anzuzeigen.',
        'file_update' => 'Erlaubt dem Benutzer, Dateien und Ordner zu aktualisieren, die dem Server zugeordnet sind.',
        'file_delete' => 'Erlaubt dem Benutzer, Dateien und Verzeichnisse zu löschen.',
        'file_archive' => 'Erlaubt dem Benutzer, Datei-Archive zu erstellen und bestehende Archive zu dekomprimieren.',
        'file_sftp' => 'Erlaubt dem Benutzer, die obigen Dateiaktionen mit einem SFTP-Programm auszuführen.',
        'allocation_read' => 'Erlaubt den Zugriff auf die Seiten zur Verwaltung der Server-Zuordnung.',
        'allocation_update' => 'Erlaubt dem Benutzer, die Zuweisungen des Servers zu modifizieren.',
        'database_create' => 'Erlaubt dem Benutzer, neue Datenbanken für den Server zu erstellen.',
