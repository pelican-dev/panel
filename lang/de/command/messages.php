...
return [
    ...
    'server' => [
        ...
        'reinstall' => [
            ...
            'confirm' => 'Du bist dabei, eine Gruppe von Servern neu zu installieren. Möchten Sie fortfahren?',
        ],
        'power' => [
            'confirm' => 'Du bist dabei, eine :action auf :count Servern auszuführen. Möchten Sie fortfahren?',
