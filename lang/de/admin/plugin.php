...
return [
    ...
    'name' => 'Name',
    'update_available' => 'Ein Update für dieses Plugin ist verfügbar',
    'author' => 'Author',
    'version' => 'Version',
    'category' => 'Kategorie',
    'status' => 'Status',
    ...
    'import_from_file' => 'Von Datei importieren',
    'import_from_url' => 'Von URL importieren',
    'no_plugins' => 'Keine Plugins',
    'all' => 'Alle',
    'change_load_order' => 'Ladereihenfolge ändern',
    'apply_load_order' => 'Ladereihenfolge anwenden',

    'enable_theme_modal' => [
        'heading' => 'Theme bereits aktiviert',
        'description' => 'Du hast bereits ein Theme aktiviert. Die Aktivierung mehrerer Themes kann zu visuellen Fehlern führen. Möchtest Du fortfahren?',
    ],
