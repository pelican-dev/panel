...
return [
    'exceptions' => [
        ...
        'default_allocation_not_found' => 'Die angeforderte Standard-Allocation wurde in den Allocations dieses Servers nicht gefunden.',
    ],
    'alerts' => [
        ...
        'node_required' => 'Du musst mindestens einen Node konfiguriert haben, bevor Du einen Server zu diesem Panel hinzufügen kannst.',
        ...
        'transfer_not_viable' => 'Der ausgewählte Node verfügt nicht über den benötigten Arbeitsspeicher oder Speicherplatz, um diesen Server unterzubringen.',
    ],
];
