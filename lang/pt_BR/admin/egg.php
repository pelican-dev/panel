...
return [
    ...
    'import' => [
        ...
        'icon_error' => 'Não foi possível obter a imagem',
        ...
        'import_result' => 'Importado :success de :total eggs',
        'imported_eggs' => 'Importado: :eggs',
        'failed_import_eggs' => 'Falha: :eggs',
        'github' => 'Adicionar do Github',
        'refresh' => 'Atualizar',
        'import_icon' => 'Importar Ícone',
        ...
        'unknown_extension' => 'Extensão de ícone desconhecido (:extension)',
        'could_not_write' => 'Não foi possível escrever o ícone no disco',
        'icon_deleted' => 'Ícone excluído',
        'no_icon' => 'Nenhum ícone fornecido',
...
Ativar esta opção desativa a comunicação interna entre servidores usando este Egg, impedindo que eles acessem outros servidores no mesmo Node pela rede interna.',
    ...
    'update_success' => ':egg atualizado com sucesso',
    'update_failed' => 'Falha ao atualizar: :eggs',
    ...
    'cannot_update' => 'Não foi possível atualizar :count egg(s)',
    'no_update_url' => 'Os Eggs a seguir não têm um conjunto de URL de atualização validos: :eggs',
    'cannot_delete' => 'Não foi possível deletar :count egg(s)',
    'eggs_have_servers' => 'Os seguintes Eggs têm servidores e não podem ser eliminados: :eggs',
    'updated_from' => 'Atualizado com sucesso de: :url',
    'update_error' => 'Erro: :error',
    'updated_eggs' => 'Atualizar: :eggs',
    'failed_eggs' => 'Falha: :eggs',
    'skipped_eggs' => 'Ignorado: :eggs',
];
