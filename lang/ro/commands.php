...
return [
    ...
    'upgrade' => [
        'integrity' => 'Această comandă nu verifică integritatea fișierelor descărcate. Asigurați-vă că aveți încredere în sursa de descărcare înainte de a continua. Dacă nu doriţi să descărcaţi o arhivă, vă rugăm să indicaţi că utilizând flagul --skip-download sau răspunzând la "nu" la întrebarea de mai jos.',
        'source_url' => 'Sursa de descărcare (setat cu --url=):',
        'php_version' => 'Imposibil de executat procesul de auto-actualizare. Versiunea minimă necesară de PHP este 7.4.0, aveți',
        'skipDownload' => 'Doriţi să descărcaţi şi să dezarhivaţi fişierele arhivă pentru cea mai recentă versiune?',
        'webserver_user' => 'Utilizatorul dvs webserver a fost detectat ca <fg=blue>[{:user}]:</> este corect?',
        'name_webserver' => 'Vă rugăm să introduceți numele utilizatorului care rulează procesul dvs de webserver. Acest lucru variază de la sistem la sistem, dar este în general "www-data", "nginx" sau "apache".',
        'group_webserver' => 'Grupul tău de webserver a fost detectat ca <fg=blue>[{:group}]:</> este corect?',
        'group_webserver_question' => 'Te rugăm să introduci numele grupului care rulează procesul tău de webserver. În mod normal, acesta este același cu utilizatorul tău.',
        'are_your_sure' => 'Ești sigur că vrei să rulezi procesul de actualizare pentru panoul tău?',
        'terminated' => 'Procesul de actualizare s-a încheiat de către utilizator.',
        'success' => 'Panoul a fost actualizat cu succes. Asiguraţi-vă că aţi actualizat, de asemenea, orice instanţă Daemon',
