...
return [
    'permissions' => [
        ...
        'setting_reinstall' => 'Permite unui utilizator să declanșeze o reinstalare a acestui server.',
        'setting_rename' => 'Permite unui utilizator să redenumească acest server și să modifice descrierea acestuia.',
        'activity_read' => 'Permite unui utilizator să vizualizeze jurnalele de activitate ale serverului.',
        'websocket_*' => 'Permite unui utilizator accesul la websocket pentru acest server.',
