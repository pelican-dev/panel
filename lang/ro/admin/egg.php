...
return [
    ...
    'import' => [
        'file' => 'Fișier',
        'url' => 'URL',
        'icon_url' => 'URL-ul iconiței',
        'icon_error' => 'Iconița nu poate fi preluată',
        ...
        'import_result' => 'Importat :success de :total eggs',
        'imported_eggs' => 'Importat: :eggs',
        'failed_import_eggs' => 'Eşuat: :eggs',
        'github' => 'Adaugă de pe GitHub',
        'refresh' => 'Reîmprospătare',
        'import_icon' => 'Importă o iconiță',
        'delete_icon' => 'Șterge iconița',
        'no_local_ip' => 'Adresele IP locale nu sunt permise',
        'unsupported_format' => 'Format neacceptat. Formate suportate: :formats',
        'invalid_url' => 'URL-ul furnizat este invalid',
        'unknown_extension' => 'Extensie de iconiță necunoscută (:extension)',
        'could_not_write' => 'Nu s-a putut salva iconița pe disk',
        'icon_deleted' => 'Iconiță ștearsă',
        'no_icon' => 'Nici o iconiță introdusă',
        'icon_updated' => 'Iconiță Actualizată',
    ],
    'export' => [
    ...
    'add_startup' => 'Adaugă comandă de pornire',
    'startup_command' => 'Comandă',
    'startup_commands' => 'Comenzi de pornire',
    'startup_name' => 'Nume afișat',
    'startup_help' => 'Comenzile de pornire disponibile pentru servere folosind acest egg. Primul este cel implicit.',
    ...
    'docker_help' => 'Imaginile docker disponibile pentru servere folosind acest egg. Primul este cel implicit.',
    ...
    'updated_skipped' => ':count omis',
    'update_success' => ':egg actualizat cu succes',
    'update_failed' => 'Actualizarea :egg a eșuat',
    ...
    'cannot_update' => 'Nu se pot actualiza :count egg(s)',
    'no_update_url' => 'Următoarele eggs nu au o adresă URL funcțională pentru actualizare: :eggs',
    'cannot_delete' => 'Nu puteți șterge :count egg(s)',
    'eggs_have_servers' => 'Următoarele eggs au servere și nu pot fi șterse: :eggs',
    'updated_from' => 'Actualizat cu succes din: :url',
    'update_error' => 'Eroare: :error',
    'updated_eggs' => 'Actualizat: :eggs',
    'failed_eggs' => 'Eşuat: :eggs',
    'skipped_eggs' => 'Omis: :eggs',
];
