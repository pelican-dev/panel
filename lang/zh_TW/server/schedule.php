...
return [
    ...
    'only_online' => '僅當伺服器上線時？',
    'only_online_hint' => '僅當伺服器處於執行狀態時才執行此排程。',
    'enabled' => '啟用排程？',
    'enabled_hint' => '如果啟用，此排程將自動執行。',

    'cron_body' => '請記住，下面的 cron 輸入始終假定為 UTC 時間。',
    'cron_timezone' => '您所在時區 (:timezone) 的下一次執行時間：<b> :next_run </b>',
