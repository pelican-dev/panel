...
return [
    ...
    'database' => [
        ...
        'fields' => [
            'host' => '資料庫主機',
            'host_help' => '您的資料庫主機。請確保它是可連線的。',
            'port' => '資料庫連接埠',
            'port_help' => '您的資料庫連接埠。',
            'path' => '資料庫路徑',
            'path_help' => '您的 .sqlite 檔案相對於資料夾的路徑。',
            'name' => '資料庫名稱',
            'name_help' => '面板資料庫的名稱。',
            'username' => '資料庫使用者名稱',
    ...
    'egg' => [
        ...
        'background_install_description' => ':count 個 Egg 的安裝已排入佇列，並將在背景繼續進行。',
        'exceptions' => [
            'failed_to_update' => '更新 Egg 索引失敗',
            'no_eggs' => '目前沒有可用的 Egg 可安裝。',
            'installation_failed' => '安裝所選的 Egg 失敗。請在安裝後透過 Egg 清單匯入它們。',
        ],
    ],
    'session' => [
        'title' => '工作階段',
    ...
    'cache' => [
        ...
        'fields' => [
            'host' => 'Redis 主機',
            'host_help' => '您的 Redis 伺服器主機。請確保它是可連線的。',
            'port' => 'Redis 連接埠',
            'port_help' => '您的 Redis 伺服器連接埠。',
            'username' => 'Redis 使用者名稱',
            'username_help' => '您的 Redis 使用者名稱。可以為空。',
            'password' => 'Redis 密碼',
    ...
    'queue' => [
        ...
        'fields' => [
            ...
            'crontab' => '執行以下命令來設定您的 crontab。請注意 <code>www-data</code> 是您的網頁伺服器使用者。在某些系統上這個使用者名稱可能會不同！',
            'service' => '要設定佇列工作服務，您只需執行以下命令。',
        ],
    ],
    'exceptions' => [
