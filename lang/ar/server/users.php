...
return [
    'permissions' => [
        ...
        'setting_reinstall' => 'يسمح للمستخدم بتشغيل إعادة تثبيت هذا الخادم.',
        'setting_rename' => 'يسمح للمستخدم بإعادة تسمية هذا الخادم وتغيير وصفه.',
        'activity_read' => 'يسمح للمستخدم بعرض سجلات أنشطة الخادم.',
        'websocket_*' => 'يسمح للمستخدم بالوصول إلى websocket لهذا الخادم.',
