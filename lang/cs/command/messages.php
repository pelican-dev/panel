...
return [
    'user' => [
        ...
        'select_search_user' => 'ID uživatele k odstranění (Enter \'0\' k opětovnému vyhledávání)',
        ...
        'multiple_found' => 'Pro uživatele bylo nalezeno více účtů, není možné odstranit uživatele z důvodu vlajky --no-interakce.',
    ...
    'environment' => [
        'mail' => [
            ...
            'ask_mailgun_secret' => 'Mailgun tajný klíč (secret)',
            'ask_mandrill_secret' => 'Mandrill tajný klíč (secret)',
