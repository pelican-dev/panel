...
#[Group('api-fixtures')]
class ActivityLogFixtureTest extends FixtureTestCase
{
    ...
    {
        $this->assertFixtureSnapshot($this->getJson(self::BASE . '/activity'));
    }

    public function test_index_with_actor(): void
    {
        $this->assertFixtureSnapshot($this->getJson(self::BASE . '/activity?include=actor'));
    }
}
