...
#[Group('api-fixtures')]
class ScheduleFixtureTest extends FixtureTestCase
{
    ...
    {
        $this->assertFixtureSnapshot($this->getJson(self::BASE . '/schedules'));
    }

    public function test_view(): void
    {
        $this->assertFixtureSnapshot($this->getJson(self::BASE . '/schedules/100'));
    }

    public function test_view_with_tasks(): void
    {
        $this->assertFixtureSnapshot($this->getJson(self::BASE . '/schedules/100?include=tasks'));
    }
}
