...
#[Group('api-fixtures')]
class BackupFixtureTest extends FixtureTestCase
{
    ...
    {
        $this->assertFixtureSnapshot($this->getJson(self::BASE . '/backups'));
    }

    public function test_view(): void
    {
        $this->assertFixtureSnapshot($this->getJson(self::BASE . '/backups/00000000-0000-4000-8000-000000000600'));
    }
}
