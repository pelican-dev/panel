...
#[Group('api-fixtures')]
class SubuserFixtureTest extends FixtureTestCase
{
    ...
    {
        $this->assertFixtureSnapshot($this->getJson(self::BASE . '/users'));
    }

    public function test_view(): void
    {
        $this->assertFixtureSnapshot($this->getJson(self::BASE . '/users/00000000-0000-4000-8000-000000000102'));
    }
}
