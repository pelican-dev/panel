...
class ActivityLogContractTest extends ContractFreezeTestCase
{
    ...
    {
        $this->assertContractSnapshot($this->getJson(self::BASE . '/activity'));
    }

    public function test_index_with_actor(): void
    {
        $this->assertContractSnapshot($this->getJson(self::BASE . '/activity?include=actor'));
    }
}
